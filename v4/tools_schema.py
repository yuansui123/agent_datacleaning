...
TOOLS_SCHEMAS: List[Dict[str, Any]] = [
    {
        "name": "compute_fft",
        "description": "Compute the one-sided magnitude FFT of a 1D signal and optionally plot it.",
        "parameters": {
            "type": "object",
            "properties": {
                "sampling_rate": {
    ...
    {
        "name": "compute_psd",
        "description": "Compute Welch power spectral density (PSD) estimate and optionally plot it.",
        "parameters": {
            "type": "object",
            "properties": {
                "sampling_rate": {
    ...
    },
    {
        ...
        "description": "Compute a time-frequency spectrogram of the signal and optionally plot it.",
        "parameters": {
            "type": "object",
            "properties": {
                "sampling_rate": {
    ...
    },
    {
        ...
        "description": "Compute and optionally plot the amplitude distribution of the signal.",
        "parameters": {
            "type": "object",
            "properties": {
                "bins": {
    ...
    },
    {
        ...
        "description": "Compute autocorrelation of the signal up to a maximum lag and optionally plot it.",
        "parameters": {
            "type": "object",
            "properties": {
                "max_lag_seconds": {
